      ...
      .then(() => {
        if (_.isNull(config)) {
          ...
          const configModel = new ConfigModel({
            ...
            ymonitor: {
                enabled: _.get(this, 'userDefinedConfig.ymonitor.enabled', process.env.YMONITOR_ENABLED) || '',
                clientId: _.get(this, 'userDefinedConfig.ymonitor.clientId', process.env.YMONITOR_CLIENT_ID) || '',
                clientSecret: _.get(this, 'userDefinedConfig.ymonitor.clientSecret', process.env.YMONITOR_CLIENT_SECRET) || '',
                redirectUri: _.get(this, 'userDefinedConfig.ymonitor.redirectUri', process.env.YMONITOR_REDIRECT_URI) || '',
              },
          });
