...
const config = new Schema({
  ...
  ymonitor: {
	    enabled: { type: Boolean, required: false, unique: false, index: false, default: true },
	    clientId: { type: String, trim: true, required: false, unique: false, index: false, default: 'DavisUser' },
	    clientSecret: { type: String, trim: true, required: false, unique: false, index: false, default: '' },
	    redirectUri: { type: String, trim: true, required: false, unique: false, index: false, default: '' },
	  },
  api: {
