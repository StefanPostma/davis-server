			      ...
			      if (choice) { // user said yes
			    	...
			    	//  var nlpObject = JSON.parse(nlp);
			    	  ...
			    	  for(var myKey in context.ketens) {
			    		  obj[myKey].push({"name": data.displayName,"category":"applications","entityId":data.id});
			    	  ...
			    	  this.davis.logger.debug('the current NLP : ' + JSON.stringify(obj));
			    	  //exchange.addNlpData(nlp);
			    	  return exchange
			    	  		.response(out)
