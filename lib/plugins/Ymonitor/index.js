...
class Ymonitor {
    ...
    this.hooks = {
      ...
      'Ymonitor:respond': (exchange, context) => {
    	  ...
    	  let out = 'You have ';
    		...
    		//  .addContext({ targetIntent: 'Ymonitor.giveChainOverview' });
		...
		//  .smartEnd(); // end the conversation if appropriate
		 ...
		 'Ymonitor:giveChainOverview': this.Ymonitor.bind(this),
		//'Ymonitor:giveChainOverview':(exchange, context) => {
		//	exchange.response('Nothing to see here!').end();	
  ...
  giveChainOverview(exchange, context) {
	 ...
	 // if (_.isBoolean(choice)) {
	 //     if (choice) { // user said yes
	 ///        return exchange.response("I'm sending the information to you now!");
	  //    } else { // user said no
